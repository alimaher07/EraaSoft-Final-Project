...
import ClientImageTwo from "../../../../public/testimonial-2.jpg"

export default function secondtStudent() {
  return (
    <>
        <div className="client-container flex flex-col items-center justify-center text-center w-100 mx-auto">
            <div className="client-img-container border-1 rounded-full border-[#52565b52]">
                <Image src={ClientImageTwo} alt="" className="rounded-full full p-2"></Image>
            </div>
            <div className="client-details my-4">
                <h2 className=" client-name font-medium text-[20px]">Sam Tony</h2>
